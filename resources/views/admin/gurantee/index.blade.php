        ...
        <div class="col-md-12">
            <div class="card mb-5">
                <div class="card-header bg-transparent">
                    <div class="row">
                        <div class="col-lg-7">
                            <h3 class="mb-0">Garantie</h3>
                        </div>
                        <div class="col-lg-5 text-right">
                            <button type="button" data-toggle="modal" data-target="#create_option" class="btn btn-sm btn-neutral">Ajouter une Garantie</button>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="modal fade" id="create_option">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{route('gurantee.store')}}" method="post" accept-charset="UTF-8" enctype="multipart/form-data">
                                                @csrf
                                            ...
                                            <div class="modal fade" id="option_{{$option->id}}">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{route('gurantee.update', $option->id)}}" method="post" accept-charset="UTF-8" enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    <div class="form-group col-md-6">
                                            ...
                                            <div class="modal fade" id="deleteOption_{{$option->id}}">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{route('gurantee.delete', $option->id)}}" method="post">
                                                            @csrf
