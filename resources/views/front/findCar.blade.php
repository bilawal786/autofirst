                                ...
                                <div class="col-md-12" style="margin-bottom: 10px">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input oninput="addoptions(this)" name="options[]" value="" data-id="{{$option->id}}" data-input="{{$option->max_input}}" min="0" data-price{{$option->id}}="{{$option->price}}" max="{{$option->max_input}}" type="number" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12" style="margin-bottom: 10px">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input onchange="addgurantee(this)" type="number" value="" name="gurantee[]" data-input="{{$optio->max_input}}" data-id="{{$optio->id}}" min="0" data-price{{$optio->id}}="{{$optio->price}}" max="{{$optio->max_input}}" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <br>
