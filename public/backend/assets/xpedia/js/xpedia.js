...
/*-----------------------------------------------------------------------------------*/
  ...
  $('input[name="date_retour"]').daterangepicker({
    singleDatePicker: true,
    timePicker:true,
    startDate: moment().startOf('hour'),
    "locale": {
  ...
  //   console.log(picker)
  //   window.localStorage.setItem("startDate",picker.startDate.format('YYYY-MM-DD'))
  //   window.localStorage.setItem("endDate",picker.endDate.format('YYYY-MM-DD'))
  //   $("#search").attr("href", "car_booking.php?date_debut="+picker.startDate.format('YYYY-MM-DD')+"&date_fin=" + picker.endDate.format('YYYY-MM-DD') + "");
  // });
